...
Я начинающий фронтенд-разработчик. Мой путь в IT начался с 11 класса, где на протяжении полугода я пробовал себя в различных направлениях, изучал язык C++, Python и знакомился с data science. Участвовал в различных олимпиадах, таких как "Мегаполис" и "Инженеры будущего". Однако больше всего меня зацепила фронтенд-разработка! С июля 2024 года я начал изучать фронтенд-разработку на курсах от Merion Academy. 
<br>
...
<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" target="_blank" rel="noreferrer">
  ...
  <img width='12' src="https://github.com/devicons/devicon/blob/master/icons/sass/sass-original.svg">
</p>
